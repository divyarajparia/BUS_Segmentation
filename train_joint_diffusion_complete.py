"""
Complete Joint Image+Mask Diffusion Training
============================================
Train a diffusion model on the FULL BUSI dataset for joint image+mask generation.
This is the DEFINITIVE version - train once, do it right!

Features:
- Joint image+mask generation
- Full BUSI dataset (485 training samples)
- Proper data loading and validation
- Robust training with checkpointing
...
def train_joint_diffusion():
    ...
    print("🏥 COMPLETE Joint Image+Mask Diffusion Training")
    print("=" * 70)
    ...
    if not os.path.exists(data_dir):
        ...
        print(f"   Please ensure the full BUSI dataset is available")
        return
